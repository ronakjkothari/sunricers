...
LEVERS = [
    ...
    {
        "id": "cool_roofs_shade",
        "title": "Cool roofs in hot corridors",
        "bucket": "before",
        "plain": "White-coat restaurant roofs in the hottest districts when they come up for recoating; plant street trees as a legacy, not a 2026 saving.",
        "owner": "City buildings dept + utility rebates",
        "touches": ["restaurant"],
        "cuts": {"restaurant": {"kwh": pc(1.5, 2.0, 4.5)}},
        "evidence": "partly untested",
        "evidence_plain": ("Metered cool-roof retrofits cut 10–30% of cooling energy, and cooling is ~15% of a restaurant's July energy, "
                           "so ≈2% of the visit for single-storey shops. Hotels save under 1% (only the top floor sits beneath the roof), so they are left out. "
                           "Trees are excluded from the cut: a planted street tree needs 10–15 years to shade anything, and it costs irrigation water."),
        "best_source": {"t": "Akbari, Levinson & Rainer 2005, monitored cool roofs on California commercial buildings",
